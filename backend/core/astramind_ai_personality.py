# backend/core/ASTRAMIND_ai_personality.py
"""
...
class AstraMindPersonality:
    ...
    slang_frequency: float = 0.8  # How often to use ASTRAMIND slang
...
class AstraMindPersonalityEngine:
    ...
    async def adapt_response(
        ...
        """
        Adapt AI response to match ASTRAMIND personality and conversation context.
        ...
        try:
            ...
            ASTRAMIND_response = await self._generate_ASTRAMIND_response(
                base_response,
                adapted_personality,
                context,
                user_analysis
    ...
    async def _safe_enhance_response(self, base_response: str, user_message: str) -> str:
        """Safely enhance response with minimal ASTRAMIND elements."""
        try:
    ...
    async def generate_conversation_title(self, conversation_history: List[str]) -> str:
        """Generate a ASTRAMIND-style conversation title."""
        ...
        if detected_themes:
            ...
            return random.choice(title_templates.get(theme, ["ASTRAMIND Chat ✨"]))
        else:
            # Generic ASTRAMIND titles
            generic_titles = [
...
astramind_personality_engine = AstraMindPersonalityEngine()

__all__ = ['AstraMindPersonalityEngine', 'astramind_personality_engine']
